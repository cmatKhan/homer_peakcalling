 ...
 */
include { HOMER_MAKETAGDIRECTORY as HOMER_MAKETAGDIRECTORY_EXP      } from '../../../modules/local/homer/maketagdirectory/main'
include { HOMER_MAKETAGDIRECTORY as HOMER_MAKETAGDIRECTORY_CNTRL    } from'../../../modules/local/homer/maketagdirectory/main'
include { HOMER_MAKEUCSCFILE                                        } from '../../../modules/local/homer/makeucscfile/main'
include { HOMER_FINDPEAKS                                           } from '../../../modules/local/homer/findpeaks/main'
...
workflow HOMER_PEAKCALLING {
    ...
    if (merge_peaks) {
        ...
        ch_merged_txt = HOMER_MERGEPEAKS.out.merged
        ...
        if (quantify_peaks && gtf) {
            ...
            ch_quantify_input = HOMER_MERGEPEAKS.out.merged
                .combine(
                    ch_sample_tagdir
                        .map { it -> it[1] }
                        .collect()
